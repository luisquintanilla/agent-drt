...
public sealed class ToolCallContext
{
    ...
    /// </summary>
    private static readonly AIFunction s_nopFunction = AIFunctionFactory.Create(() => { }, nameof(ToolCallContext));
    ...
    private FunctionCallContent _callContent = new(string.Empty, s_nopFunction.Name, ReadOnlyDictionary<string, object?>.Empty);
    ...
    {
        get => this._callContent;
        set
        {
            ArgumentNullException.ThrowIfNull(value);
            this._callContent = value;
        }
    }
